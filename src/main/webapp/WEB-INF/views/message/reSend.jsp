						...
						<div class="card">
							<div class="card-body">
								<form action="/message/send" method="post" onsubmit="return check()" name="fr">
									...
									<div class="row">
										<div class="col-sm-12">
											<input type="text" class="form-control" name="toUser" value="${toUser }" readonly="readonly">
										</div>
									</div>
															
									<div class="row" style="margin-top: 8px;">
										<div class="col">
											<textarea class="form-control" maxlength="1000" rows="5" name="toContent" style="height: 300px;"></textarea>
										</div>
									</div>
